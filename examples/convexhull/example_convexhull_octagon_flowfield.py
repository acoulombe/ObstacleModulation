...
in_collision = octagon.check_collision(pos)
pos_valide = pos[~in_collision]

dist = octagon.gamma_func(pos).reshape((splits, splits))
...
modulation = octagon.get_modulation_matrix(pos_valide, dynamics(pos_valide, goal), tail_effects=True)
