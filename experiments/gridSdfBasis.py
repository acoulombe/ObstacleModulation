...
# plt.quiver(pos[idx,0], pos[idx,1], grad[idx,0], grad[idx,1], color="b")
plt.quiver(pos[idx,0], pos[idx,1], basis[idx,0,0], basis[idx,1,0], color="b")
plt.quiver(pos[idx,0], pos[idx,1], basis[idx,0,1], basis[idx,1,1], color="g")
