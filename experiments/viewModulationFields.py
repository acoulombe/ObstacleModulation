...
M = box1.get_modulation_matrix(pos)
E = box1.get_basis_matrix(pos)
D = box1.get_diagonal_matrix(pos)
gammas = box1.gamma_func(pos).reshape(cell_count, cell_count)
dist = box1.sdf(pos).reshape(cell_count, cell_count)
...
ax[0,2].contour(x, y, gammas, 50, colors='k')

ax[1,0].set_title("SDF")
ax[1,0].contourf(x, y, dist, 50, cmap='coolwarm')
ax[1,0].contour(x, y, dist, 50, colors='k')
...
box1.plot_obstacle(ax[0,0])
box1.plot_obstacle(ax[0,1])
box1.plot_obstacle(ax[0,2])
box1.plot_obstacle(ax[1,0])
box1.plot_obstacle(ax[1,1])
box1.plot_obstacle(ax[1,2])
